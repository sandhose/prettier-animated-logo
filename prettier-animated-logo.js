...
var Svg = function Svg(_ref3) {
  ...
  return (0, _preact.h)(
    ...
    lines.map(function (_ref4, index) {
      ...
      return (0, _preact.h)(Line, { total: total, dashes: dashes, index: index });
    })
  );
};
...
(0, _preact.render)((0, _preact.h)(
  "div",
  { id: "app" },
  (0, _preact.h)(Svg, { id: "wide", data: _wide2.default }),
  (0, _preact.h)(Svg, { id: "icon", data: _icon2.default })
), document.body);
},{"preact":6,"./wide.json":3,"./icon.json":4,"./style.styl":5}],0:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://' + window.location.hostname + ':62956/');
