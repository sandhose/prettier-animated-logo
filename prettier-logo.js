...
var Svg = function Svg(_ref3) {
  ...
  return (0, _preact.h)(
    ...
    lines.map(function (_ref4, index) {
      ...
      return (0, _preact.h)(Line, { dashes: dashes, index: index });
    })
  );
};
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        "div",
        null,
        (0, _preact.h)(Svg, { active: this.state.active, lines: _lines2.default }),
        (0, _preact.h)(
          "button",
          { onClick: toggle },
          "Animate"
...
},{"preact":6,"./lines.json":3,"./style.styl":4}],0:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://' + window.location.hostname + ':55847/');
